...
class EngineDirective(SphinxDirective):
    ...
    def run(self):
        engines_file = os.path.join(
            os.path.dirname(os.path.dirname(__file__)), "engines.ini"
        )
        ...
        values = {
            "collect_points": available_collect_point_engines,
            "backup_points": available_backup_point_engines,
            "sources": available_source_engines,
            "filters": available_filter_engines,
